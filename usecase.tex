...
\UseCaseLabel{Log into system}
\UseCaseDescription{The ability for an actor to log into the system using a valid username and password}
\UseCaseRationale{An actor should be able to log into the
...
\UseCaseStatus{Not yet implemented}
\UseCaseActors{Student, Course Coordinator, Company}
...
\UseCaseExtensions{Course Coordinator Reviews Advertisement}
...
\UseCasePriority{Must Have}
\UseCaseStatus{Implemented in first prototype}
\UseCaseActors{Student}
\UseCaseIncludes{Log into System. Company Posts Application. }
...
\begin{UseCaseTemplate}
\UseCaseLabel{Submit Advertisement}
\UseCaseDescription{A potential Company will submit an advertisement
...
\begin{UseCaseTemplate}
\UseCaseLabel{Edit Advertisement}
\UseCaseDescription{An advertisement can be edited prior to its publication.}
...
\UseCaseExtensions{Submit Advertisement. Reviews Advertisement.}
...
\begin{UseCaseTemplate}
\UseCaseLabel{Review Advertisement}
\UseCaseDescription{As the original specification, each individual advertisement must be reveiwed before
  publishing for viewing.}
\UseCaseRationale{Specified inside the original specification.}
\UseCasePriority{Must Have}
\UseCaseStatus{Implemented in first prototype}
\UseCaseActors{Course Coordinator}
\UseCaseIncludes{Submit Application}
...
\begin{UseCaseTemplate}
\UseCaseLabel{Notification of Successful Application}
...
\UseCaseExtensions{Log into System.}
\UseCaseIncludes{Submit Application}
